...
1. #### Clean the data and check for parsing errors
   ...
   Have a look at the table I provided you with.
...
3. #### FURIGANA THIS IS EXTREMELY IMPORTANT!
...
4. #### Output
   ...
   <!-- - Output the CSV data without backticks or other formatting characters. -->
